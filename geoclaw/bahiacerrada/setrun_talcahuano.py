...
#------------------------------
    ...
    clawdata.lower[0] = 0.+500.      # west longitude
    clawdata.upper[0] = 0..+640*54.      # east longitude

    clawdata.lower[1] = 0..   +54.   # south latitude
    clawdata.upper[1] = 0.+640*54.         # north latitude
...
#-------------------
    ...
    topo_data.topofiles.append([3, 1, 3, 0., 1.e10, 'data/talcahuano4.asc'])
