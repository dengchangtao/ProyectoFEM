...
#------------------------------
    ...
    clawdata.num_cells[0] = nx/4
    clawdata.num_cells[1] = ny/4
	...
	nt=10
        clawdata.num_output_times = nt*10
        clawdata.tfinal = nt*T
    ...
    regions.append([1,1,0.,1e99,xl,xr,yl,yu])
    regions.append([1,10,0.,1e99,0.,lx,-ly,ly])
...
#-------------------
    ...
    topo_data.topofiles.append([2, 1, 10, 0., 1.e10, 'bati.tt2'])
